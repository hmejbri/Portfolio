...
const landing1 = dataEN.landing;

const professionalDetails = landing1.professionalDetails.map(({ alt, icon, link }) => {
...
export default function Landing() {
	...
	useEffect(() => {
		if (router.query.language == "FR") setLanding(dataFR.landing);
		else setLanding(dataEN.landing);
